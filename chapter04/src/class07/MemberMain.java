...
public class MemberMain {
	...
	public static void main(String[] args) {
		...
		// Memeber클래스 Type의 변수 members를 선언한다.
		// memebers에 Member 객체를 담을 수 있는 98칸 짜리 공간을 확보 한다.
	...
	private static void printMember(Member[] member) {
		System.out.println("이름\t가입일\t\t최종방문일\t\t방문횟수\t성별\t연령대");
		for (Member memberString : member) {
			System.out.println(memberString.getName() + "\t" + memberString.getJoinDate() + "\t" 
						+ memberString.getLastVisitDate() + "\t" + memberString.getNumVisit() + "\t"
						+ memberString.getGender() + "\t" + memberString.getAge());
		}
		System.out.println();
	}
	
	// 20대후반 여성 총 방문 횟수 합산 메소드
	...
	private static int getCount40(Member[] members) {
		...
		for (Member mem : members) {
			...
			//if (mem.getAge().contains("40대") || mem.getAge().contains("50대") || mem.getAge().contains("60대")) {
				//count ++;
			//}
		}
		return count;
